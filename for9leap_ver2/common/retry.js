 ...
 */
function showUIRetry(scene, buttonColor, textColor, listener) {
  ...
  //処理
  showButton(scene, "Retry", textColor, "16pt 'PixelMplus10'", buttonColor, 115, 25);
  ...
  function showButton(scene, text, textColor, font, buttonColor, width, height) {
    ...
    button.x = scene.width * 0.0 + ((scene.width * 0.5) - button.width) * 0.5;
